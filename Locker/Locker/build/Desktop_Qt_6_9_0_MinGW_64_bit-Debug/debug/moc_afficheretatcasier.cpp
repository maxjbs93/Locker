...
namespace {
struct qt_meta_tag_ZN18afficheretatcasierE_t {};
} // unnamed namespace

template <> constexpr inline auto afficheretatcasier::qt_create_metaobjectdata<qt_meta_tag_ZN18afficheretatcasierE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<afficheretatcasier, qt_meta_tag_ZN18afficheretatcasierE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject afficheretatcasier::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18afficheretatcasierE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18afficheretatcasierE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18afficheretatcasierE_t>.metaTypes,
    nullptr
} };
...
void *afficheretatcasier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18afficheretatcasierE_t>.strings))
