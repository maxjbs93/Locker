...
public:
    ...
    QPushButton *pushButton_supp_commande;
    ...
    void setupUi(QMainWindow *MainPage)
    {
        ...
        label_title->setGeometry(QRect(170, 10, 271, 71));
        QFont font;
        ...
        label_title_2->setGeometry(QRect(120, 80, 361, 71));
        QFont font1;
        ...
        pushButton_supp_commande = new QPushButton(groupBox);
        pushButton_supp_commande->setObjectName("pushButton_supp_commande");
        pushButton_supp_commande->setGeometry(QRect(120, 280, 361, 41));
        pushButton_supp_commande->setFont(font2);
    ...
    void retranslateUi(QMainWindow *MainPage)
    {
        ...
        pushButton_supp_commande->setText(QCoreApplication::translate("MainPage", "Supprimer une commande existante", nullptr));
