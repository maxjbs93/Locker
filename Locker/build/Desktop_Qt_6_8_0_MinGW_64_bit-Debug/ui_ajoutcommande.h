...
public:
    ...
    void setupUi(QMainWindow *ajoutcommande)
    {
        ...
        label_2->setGeometry(QRect(0, 70, 801, 71));
        QFont font1;
        ...
        comboBox_taille->setGeometry(QRect(300, 240, 431, 30));
